...
ggplot(meltdf,aes(x=date, y=value, colour=variable, group=variable)) +
  ...
  scale_x_discrete (breaks=c("2015-01-01", "2015-06-01",
     "2016-01-01", "2016-06-01", "2017-01-01", "2017-06-01", "2018-01-01", "2018-06-01", "2019-01-01" ),
  labels=c("2015-01", "2015-06", "2016-01", "2016-06",
     "2017-01", "2017-06", "2018-01", "2018-06", "2019-01")  )
...
pN <- ggplot(meltdf,
 ...
 stat_smooth(method = "lm", se=F) +
  ...
  "2016-06", "2017-01", "2017-06", "2018-01", "2018-06", "2019-01")  )
