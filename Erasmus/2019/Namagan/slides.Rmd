...
BTW province is Polish is "prowincja" (due to both are from Latin) but actually 
...
(Almost) each Poland is attractive for tourist but those counties which are at the seaside (north) 
...
Heatmaps shows density more clearly (or nor--opinions are contradictory):
