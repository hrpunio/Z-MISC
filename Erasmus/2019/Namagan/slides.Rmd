...
* *Poor definitions*: 
complexity of statistical data collection: pimprecise, complex, *unintuitive*,
...
*beliefs* and *intensions*. For example number of hotels is a fact,
while intension to stay abroad less than a year is not a fact but an intention.
...
this topic is usually coverd marginally at most courses on statistics,
...
(Almost) each Poland is acctarctive for tourist but those counties which are at the seaside (north) 
...
So each new hotel in the mointains on the average would attract 961.6 foreign tourists,
...
of influential polish weeekly magazine
form Janury 2015, about five months before elections (which took place in may 2015).
